    ...
    return (
        <>
            ...
            <div className="fixed bottom-0 flex flex-col items-center bg-white">
                <button className="bg-[#4514a3] flex items-center justify-center gap-4 font-bold py-4 sm:px-20 px-16 text-white text-xl rounded-md shadow-md hover:bg-[#3b0f8c] transition-colors duration-300 cursor-pointer" onClick={() => document.getElementById('file-upload')!.click()}>
